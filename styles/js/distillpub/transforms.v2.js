...
`
      ...
      })(
        {
                  ...
                  },
                  {
                    ...
                    value: function fontMetrics () {
                      if (!this._fontMetrics) {
                        this._fontMetrics = _fontMetrics3.default.getFontMetrics(
                          this.size,
                        )
                      }
          ...
          38: [
            function (require, module, exports) {
               ...
               */
              var mathrmSize = function mathrmSize (
                value,
                size,
                mode,
                options,
    ...
    if (data.doiSuffix) {
      ...
      if (data.publishedDate) {
        meta(
          ...
          `${data.publishedYear}/${data.publishedMonthPadded}/${
            data.publishedDayPadded
          }`,
        )
        meta(
  ...
  function citation_meta_content (ref) {
    ...
    let arxiv_id_search = /https?:\/\/arxiv\.org\/pdf\/([0-9]*\.[0-9]*)\.pdf/.exec(
      ref.url,
    )
    arxiv_id_search =
      arxiv_id_search ||
