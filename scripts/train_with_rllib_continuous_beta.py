...
from scripts.torch_models_continuous_beta import CustomBetaPolicyModel
...
def trainer(
    ...
    # -----------------------------------------------------------------------------
    config_path = os.path.join(PUBLIC_REPO_DIR, "scripts", "rice_rllib_beta.yaml")
    ...
    with open(os.path.join(save_dir, "rice_rllib_continuous_beta.yaml"), "w") as yaml_file:
...
if __name__ == "__main__":
    ...
    # Note: The run config yaml(s) can be edited at warp_drive/training/run_configs
    # -----------------------------------------------------------------------------
    config_path = os.path.join(PUBLIC_REPO_DIR, "scripts", "rice_rllib_continuous_beta.yaml")
    if not os.path.exists(config_path):
        raise ValueError(
            "The run configuration is missing. Please make sure the correct path "
            "is specified."
    ...
    for file in ["rice_rllib_continuous_beta.yaml"]:
        shutil.copyfile(
